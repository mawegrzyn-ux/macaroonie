-- 103_cash_week_summary_grid_widget.sql
--
-- New Cash Dashboard widget type:
--   cash_week_summary_grid  the reconciliation grid's rows with only the
--                           week total column (no individual days)
--
...
ALTER TABLE hs_dashboard_widgets
  ...
  CHECK (widget_type IN (
    ...
    'cash_week_expenses', 'cash_week_summary_grid'
  ));
